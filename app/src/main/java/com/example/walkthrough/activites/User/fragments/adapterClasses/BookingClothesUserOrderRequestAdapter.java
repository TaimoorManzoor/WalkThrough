...
public class BookingClothesUserOrderRequestAdapter extends RecyclerView.Adapter<BookingClothesUserOrderRequestAdapter.TailorListViewHolder>{
    private ArrayList<BookingClothesDetailsModelClass> tailorList;
    Context context;
    FirebaseDatabase database;
    DatabaseReference reference;
    FirebaseAuth mAuth;
    public BookingClothesUserOrderRequestAdapter(ArrayList<BookingClothesDetailsModelClass> tailorList, Context context) {
