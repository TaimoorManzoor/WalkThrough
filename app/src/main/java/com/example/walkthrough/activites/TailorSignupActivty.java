...
public class TailorSignupActivty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tailor_signup_activty);
        ids();
        clicklistener();
        ...
        signInLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(TailorSignupActivty.this,TailorSignInActivtiy.class);
...
//                name=edusername.getText().toString().trim();
                ...
                if(edpassword.getText().toString().isEmpty()||
                    ...
                    Toast.makeText(TailorSignupActivty.this, "Enter Detail please", Toast.LENGTH_SHORT).show();

                }else if(edpassword.getText().toString().length()<6){
                    Toast.makeText(TailorSignupActivty.this, "Enter valid password", Toast.LENGTH_SHORT).show();
                }else if(!edemail.getText().toString().contains("@gmail.com")){
                    Toast.makeText(TailorSignupActivty.this, "Enter valid email", Toast.LENGTH_SHORT).show();
                } else if (!userconpass.equals(userpassword)) {
                    Toast.makeText(TailorSignupActivty.this, "Passwords are not equals", Toast.LENGTH_SHORT).show();
                } else{
                    dialog = new ProgressDialog(TailorSignupActivty.this);
        ...
        mAuth.createUserWithEmailAndPassword(email, pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    userid = user.getUid();
                    Intent obj =new Intent(getApplicationContext(),TailorSignInActivtiy.class);
                    startActivity(obj);
                    Toast.makeText(TailorSignupActivty.this, "Welcome", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(TailorSignupActivty.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void AddUSerDataToRealtime(String userid,String name,String email,String pass,String conpass,String number){
        ...
        DatabaseReference myRef = database.getReference("SailAppForTailor").child("Account Details");
        ...
        myRef.child(userid).setValue(obj).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(TailorSignupActivty.this, "Sucesfully Updated", Toast.LENGTH_SHORT).show();
                }
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
