...
public class FetchAdapterImage extends RecyclerView.Adapter<FetchAdapterImage.TailorListViewHolder>{
    private List<ImageModel> imageList;
    private Context context;

    public FetchAdapterImage(Context context, List<ImageModel> imageList) {
