...
public class ConfrimedOrderUserOrderAdapter extends RecyclerView.Adapter<ConfrimedOrderUserOrderAdapter.TailorListViewHolder>{
    private ArrayList<BookingDetailModelClass> tailorList;
    Context context;
    FirebaseDatabase database;
    DatabaseReference reference;
    FirebaseAuth mAuth;
    public ConfrimedOrderUserOrderAdapter(ArrayList<BookingDetailModelClass> tailorList, Context context) {
    ...
    public void onBindViewHolder(@NonNull TailorListViewHolder holder, int position) {
        ...
        holder.cardview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent obj = new Intent(context, ViewUserMeasurementDetailsActivity.class);
