...
public class HomeTailorFragment extends Fragment
{
    FragmentHomeTailorBinding binding;
    public HomeTailorFragment()
    {
                             ...
                             Bundle savedInstanceState)
    {
        ...
        binding=FragmentHomeTailorBinding.inflate(inflater,container,false);
