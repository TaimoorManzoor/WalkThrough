...
public class NewTailorUpdateProfileFragment extends Fragment {

    String userUid;
    ImageView imageView;
    EditText edtxtname,edtxtadd,edtxtPrice,edphonenumber;
    Button btnupdate;
    ...
    public NewTailorUpdateProfileFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_new_tailor_update_profile, container, false);
        IDs(view);
        SetDetails();
        ClickListener();
    ...
    private void IDs(View view) {
        ...
        edtxtadd=view.findViewById(R.id.edaddressesid);
        edtxtPrice=view.findViewById(R.id.edpriceid);
        edphonenumber=view.findViewById(R.id.edphonenumberid);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    Glide.with(requireContext()).load(obj.getImageurl()).into(imageView);
                    edtxtname.setText(obj.getUsername());
                    edtxtadd.setText(obj.getTailoraddresses());
                    edtxtPrice.setText(obj.getTailorprice());
                    edphonenumber.setText(obj.getPhone());
                }
            }
            @Override
                                        ...
                                        UploadTask.TaskSnapshot taskSnapshot)
                                {
                                    ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onSuccess(Uri uri) {
                                            ...
                                            DatabaseReference usersRef = database.getReference("TailorProfile").child("Tailor").child(userUid);
...
//                                                    Log.d(TAG, "onComplete: "+Updated);
    ...
    private void updateprofileID(){
        ...
        updates.put("tailorprice",edtxtPrice.getText().toString().trim());
        updates.put("tailoraddresses",edtxtadd.getText().toString().trim());
        updates.put("phone",edphonenumber.getText().toString().trim());
