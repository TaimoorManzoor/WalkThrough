package com.example.walkthrough.SharedPrefPkg;
...
public class PrefManager {
    ...
    public  void setCurrentstatus(String currentstatus1)
    {
        editor.putString(currentstatus,currentstatus1);
        editor.apply();

    }
    public  String getCurrentstatus() {

        return sharedPreferences.getString(currentstatus,"0");
    }
}